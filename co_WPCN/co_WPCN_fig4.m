...
for K=0.3:0.4:0.7% channel pathloss
 ...
 legend('with co-user:K=0.3','without co-user:K=0.3','with co-user:K=0.7','without co-user:K=0.7');
  
 
 
 xlabel('Throughput of U_2 (bps/Hz)')
 ylabel('Throughput of U_1 (bps/Hz)')
grid on
